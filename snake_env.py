...
class SnakeEnv:
    ...
    def __init__(self, grid_size=6, initial_length=2, max_steps=1000, seed=None):
        """
        参数：
    ...
    def seed(self, seed):
        """Reset the environment's local random number generator."""
        self._rng.seed(seed)
    ...
    def reset(self):
        ...
        self.direction = self._rng.choice([0, 1, 2, 3])
    ...
    def _place_food(self):
        ...
        if not available:
            ...
            self.food = list(self._rng.choice(available))
